...
model_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "model_building", "best_model.joblib")) 
# by train.py (must match the filename you used there)model = joblib.load(model_path)
